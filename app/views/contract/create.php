<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="duration" placeholder="Enter duration" name="duration" value="<?php echo isset($_POST['duration']) ? $_POST['duration'] : "" ?>">
    </div>
    <div class="form-group">
        <label for="from">Từ ngày (*): </label>
        <input type="date" class="form-control" id="from" placeholder="Enter from" name="from" value="<?php echo isset($_POST['from']) ? $_POST['from'] : "" ?>">
    </div>
    <div class="form-group">
        <label for="to">Đến ngày (*): </label>
        <input type="date" class="form-control" id="to" placeholder="Enter to" name="to" value="<?php echo isset($_POST['to']) ? $_POST['to'] : "" ?>">
    </div>
    <div class="form-group">
